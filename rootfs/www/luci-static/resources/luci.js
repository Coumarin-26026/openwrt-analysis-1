...
return null;if(Array.isArray(children)){for(let i=0;i<children.length;i++){if(this.elem(children[i]))
node.appendChild(children[i]);else if(children[i]!==null&&children[i]!==undefined)
